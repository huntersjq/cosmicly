...
export function FeaturesLines() {
  const steps = [
    ...
    { title: "Enter Details", desc: "Input your birth date, time, and location" },
    ...
    <section className="py-24 relative overflow-hidden">
      <div className="container px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">How Hint Works</h2>
                ...
                <div className="hidden md:block flex-1 w-full text-right px-12">
                   {i % 2 === 0 ? (
                      ...
                      <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                         <div className="h-32 bg-white/5 rounded-lg w-full flex items-center justify-center text-muted-foreground/30">Visual Placeholder</div>
                      </div>
                   )}
                </div>
